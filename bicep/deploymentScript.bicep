...
output namespace string = deploymentScript.properties.outputs.namespace
output ingressHostExternal string = deploymentScript.properties.outputs.ingressHostExternal
output ingressPortExternal string = deploymentScript.properties.outputs.ingressPortExternal
output gatewayUrlExternal string = deploymentScript.properties.outputs.gatewayUrlExternal
output bookInfoUrlExternal string = deploymentScript.properties.outputs.bookInfoUrlExternal
